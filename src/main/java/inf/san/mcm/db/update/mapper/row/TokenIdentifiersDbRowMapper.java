...
public class TokenIdentifiersDbRowMapper extends AbstractDbRowMapper implements RowMapper<TokenIndentifiersDb> {

	@Override
	public TokenIndentifiersDb mapRow(ResultSet rs, int rowNum) throws SQLException {
		TokenIndentifiersDb result = new TokenIndentifiersDb();
